...
export const projects: Project[] = [
  {
    ...
    coverImage: 'https://api.microlink.io?url=https%3A%2F%2Fwww.getchapterly.com&screenshot=true&meta=false&embed=screenshot.url',
    coverColor: '#1a1a2e',
  ...
  },
  {
    ...
    coverImage: 'https://api.microlink.io?url=https%3A%2F%2Ffinance-dashboard-max.vercel.app&screenshot=true&meta=false&embed=screenshot.url',
    coverColor: '#0a1628',
  ...
  },
  {
    ...
    coverImage: 'https://api.microlink.io?url=https%3A%2F%2Fnetworking-crm-eta.vercel.app&screenshot=true&meta=false&embed=screenshot.url',
    coverColor: '#0a1628',
  ...
  },
  {
    ...
    highlights: [
      ...
      'One-click PDF export with branded layout via @react-pdf/renderer',
      'Parallel scraping pipeline — site crawl and search queries run concurrently to minimize latency',
    ],
    metrics: {},
    lessons: [],
    featured: false,
