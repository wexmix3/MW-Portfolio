...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description:
      'A comprehensive personal finance tracker for logging income and expenses, tracking budgets, monitoring net worth over time, and analyzing spending by category. Built across 7 phases with 61 files, it features real-time portfolio performance, category-level budget analysis, and interactive Recharts visualizations.',
    status: 'in-progress',
